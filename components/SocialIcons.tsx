...
const SocialIcons = () => {
  ...
  //TODO Hover state to change colors of icons
  return (
    <Social>
      <span tw={"px-2"}>
        <Link href={"https://www.linkedin.com/in/majid-popo-400291213"}>
          <a>
            <svg
              tw={
                "fill-current text-gray-400 dark:text-white hover:text-blue-400"
              }
              xmlns="http://www.w3.org/2000/svg"
              width="24"
              height="24"
              viewBox="0 0 24 24"
              fill={darkMode ? "#fff" : "#c2c2c2"}
              strokeWidth="1.5"
              display="block"
              id="LinkedInFill"
            >
      ...
      <hr tw={"border-l-2 border-gray-300 h-6"} />
      <span tw={"px-2"}>
