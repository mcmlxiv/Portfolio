...
export const RememberTodoPurpose = `This project included 4 phases and iterations of the site. Phase 1 simply creating the front-end UI structure and elements with and storing the todos created within memory.
...
export const RememberTodoProblems = `Like most projects, I ran into a few bumps whilst implementing this app, one particular issue was ensuring code readability and ease of access for user. `;
...
export const Starbucks = `Ecommerce React app built with React-Redux, Firebase, Material UI and Framer Motion. A clone for the most popular coffee company in the world! `;

export const StarbucksProject = `This app is a Starbucks ecommerce app clone built for users to buy their favorite type of coffee and or deserts.  I built this project from scratch with React, React-Redux, Firebase, Framer Motion and Material UI.
`;
export const StarbucksProjectCont = `With this app I wanted to challenge myself to recreate an already existing web app it took a lot of time and deep research to implement. The next iteration is to move on to an SSR to further improve page speed, optimize user experience.`;

export const StarbucksPurpose = `This project included 3 phases and iterations of the site. Phase 1 recreating the front-end UI structure and elements of the starbucks website.
Phase 2 was much larger as it involved creating interactivity of the pages and utilizing redux  and extending it to allow for user sign ups and sign ins. 
`;

export const StarbucksPurposeCont = `Phase 3 was storing the data and processing it on a firebase server
and allowing for the frontend to consume the data from the locally created API.`;

export const StarbucksStack = `Using CRA (Create React App) wasn't the clearest choice for this web app but at the time of creation was usable. A Static page generator such as NextJs or GatsbyJs would have produced a more optimized
 product. Redux was used to help persist user account state within the app and Firebase was used to automatically allow for sign in and sign up functionality. The icons were provided by Material UI`;
export const StarbucksProblems = `Like most projects, I ran into a few bumps whilst implementing this app, one particular issue was ensuring code readability and ease of access for user. `;
export const StarbucksProblemsCont = `After learning more and more about my issues within this app I have grown incredibly, and understood not only my perspective but others as well. I have made a bigger
effort to ensure my code is more readable and reusable and utilized props and state in many places reducing repeated code.`;
export const StarbucksLessons = `I have learnt many things creating this app. As I wasn't very well accustomed to using Firebase or using React-Redux. `;

export const Blog = `Blog NextJS app built with GhostCMS, TypeScript built for future blogging on an ultrafast framework NextJS! `;

export const BlogProject = `This app is a blog app clone built for users to read and write about their favorite topics.  I built this project from scratch with React, NextJS, GhostCMS.
`;
export const BlogProjectCont = `With this app I wanted to challenge myself to create blog implementation. The next iteration is to move on to a more robust and flushed out design and to allow for comments.`;

export const BlogPurpose = `This project included 3 phases and iterations of the site. Phase 1 recreating the front-end UI structure and elements of the blog website.
Phase 2 was much larger as it involved creating dynamically loaded pages from NextJS SSR. 
`;

export const BlogPurposeCont = `Phase 3 was creating GhostCMS api hosted on Heroku. Phase 4 was to hook up the frontend to allow it to consume data from the GhostCMS api and output that to the user.`;

export const BlogStack = `Using NextJS SSR was the clearest choice as this was the fastest and most up to date blog construction style. Server side rendering was used to dynamically produce pages as this would
allow authors to create blogs and implement them, this produces the pages instantly to their readers.`;
export const BlogProblems = `Like most projects, I ran into a few bumps whilst implementing this app, one issue was setting up an online server for authors to write to, this was solved by implement GhostCMS on Heroku `;
export const BlogProblemsCont = `After learning more and more about my issues within this app I have a deeper understanding of SSR and online CMS tools.`;
export const BlogLessons = `I have learnt many things creating this app. As I wasn't very well accustomed to using GhostCMS or its blogging features.`;
